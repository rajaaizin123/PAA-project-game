...
c: raylib
ifneq (,$(c_config))
	@echo "==== Building c ($(c_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f c.make config=$(c_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f c.make clean
